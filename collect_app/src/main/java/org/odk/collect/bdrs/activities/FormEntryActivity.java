...
import org.odk.collect.bdrs.dao.helpers.FormsDaoHelper;
import org.odk.collect.bdrs.dao.helpers.InstancesDaoHelper;
import org.odk.collect.bdrs.events.ReadPhoneStatePermissionRxEvent;
import org.odk.collect.bdrs.events.RxEventBus;
import org.odk.collect.bdrs.exception.JavaRosaException;
import org.odk.collect.bdrs.external.ExternalDataManager;
import org.odk.collect.bdrs.formentry.FormEntryMenuDelegate;
import org.odk.collect.bdrs.formentry.FormEntryViewModel;
import org.odk.collect.bdrs.formentry.FormIndexAnimationHandler;
import org.odk.collect.bdrs.formentry.FormLoadingDialogFragment;
import org.odk.collect.bdrs.formentry.ODKView;
import org.odk.collect.bdrs.formentry.QuitFormDialog;
import org.odk.collect.bdrs.formentry.audit.AuditEvent;
import org.odk.collect.bdrs.formentry.audit.AuditUtils;
import org.odk.collect.bdrs.formentry.audit.ChangesReasonPromptDialogFragment;
import org.odk.collect.bdrs.formentry.audit.IdentifyUserPromptDialogFragment;
import org.odk.collect.bdrs.formentry.audit.IdentityPromptViewModel;
import org.odk.collect.bdrs.formentry.backgroundlocation.BackgroundLocationManager;
import org.odk.collect.bdrs.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.odk.collect.bdrs.formentry.repeats.AddRepeatDialog;
...
import org.odk.collect.bdrs.fragments.MediaLoadingFragment;
import org.odk.collect.bdrs.fragments.dialogs.CustomDatePickerDialog;
import org.odk.collect.bdrs.fragments.dialogs.LocationProvidersDisabledDialog;
import org.odk.collect.bdrs.fragments.dialogs.NumberPickerDialog;
import org.odk.collect.bdrs.fragments.dialogs.ProgressDialogFragment;
import org.odk.collect.bdrs.fragments.dialogs.RankingWidgetDialog;
import org.odk.collect.bdrs.javarosawrapper.FormController;
import org.odk.collect.bdrs.javarosawrapper.FormController.FailedConstraint;
import org.odk.collect.bdrs.listeners.AdvanceToNextListener;
import org.odk.collect.bdrs.listeners.FormLoaderListener;
import org.odk.collect.bdrs.listeners.PermissionListener;
import org.odk.collect.bdrs.listeners.SavePointListener;
import org.odk.collect.bdrs.listeners.WidgetValueChangedListener;
import org.odk.collect.bdrs.logic.FormInfo;
import org.odk.collect.bdrs.logic.ImmutableDisplayableQuestion;
...
import org.odk.collect.bdrs.tasks.FormLoaderTask;
import org.odk.collect.bdrs.tasks.SaveFormIndexTask;
import org.odk.collect.bdrs.tasks.SaveFormToDisk;
import org.odk.collect.bdrs.tasks.SavePointTask;
import org.odk.collect.bdrs.upload.AutoSendWorker;
import org.odk.collect.bdrs.utilities.ApplicationConstants;
import org.odk.collect.bdrs.utilities.DestroyableLifecyleOwner;
import org.odk.collect.bdrs.utilities.DialogUtils;
import org.odk.collect.bdrs.utilities.FileUtils;
import org.odk.collect.bdrs.utilities.FormNameUtils;
import org.odk.collect.bdrs.utilities.ImageConverter;
import org.odk.collect.bdrs.utilities.MediaManager;
...
import org.odk.collect.bdrs.utilities.SnackbarUtils;
import org.odk.collect.bdrs.utilities.SoftKeyboardUtils;
import org.odk.collect.bdrs.utilities.ToastUtils;
import org.odk.collect.bdrs.widgets.DateTimeWidget;
import org.odk.collect.bdrs.widgets.QuestionWidget;
import org.odk.collect.bdrs.widgets.RangeWidget;
...
import static org.odk.collect.bdrs.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static org.odk.collect.bdrs.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.odk.collect.bdrs.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.odk.collect.bdrs.utilities.AnimationUtils.areAnimationsEnabled;
import static org.odk.collect.bdrs.utilities.ApplicationConstants.RequestCodes;
...
import static org.odk.collect.bdrs.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.odk.collect.bdrs.utilities.PermissionUtils.finishAllActivities;
import static org.odk.collect.bdrs.utilities.ToastUtils.showLongToast;
import static org.odk.collect.bdrs.utilities.ToastUtils.showShortToast;
