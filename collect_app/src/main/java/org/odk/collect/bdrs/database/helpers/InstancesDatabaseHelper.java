...
import org.odk.collect.bdrs.provider.InstanceProviderAPI;
...
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.CAN_EDIT_WHEN_COMPLETE;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.DELETED_DATE;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.DISPLAY_NAME;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.GEOMETRY;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.GEOMETRY_TYPE;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.INSTANCE_FILE_PATH;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.JR_FORM_ID;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.JR_VERSION;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.LAST_STATUS_CHANGE_DATE;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.STATUS;
import static org.odk.collect.bdrs.provider.InstanceProviderAPI.InstanceColumns.SUBMISSION_URI;
...
public class InstancesDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String[] COLUMN_NAMES_V6 = {_ID, DISPLAY_NAME, SUBMISSION_URI, CAN_EDIT_WHEN_COMPLETE,
            INSTANCE_FILE_PATH, JR_FORM_ID, JR_VERSION, STATUS, LAST_STATUS_CHANGE_DATE, DELETED_DATE,
    ...
    public static boolean databaseNeedsUpgrade() {
        ...
        try {
            ...
            Timber.i(e);
            //Timber.i("%s ::::: Here is the Problem:::: ",isDatabaseHelperOutOfDate);
        }
