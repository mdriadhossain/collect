...
package org.odk.collect.bdrs.provider;
...
import static org.odk.collect.bdrs.database.helpers.InstancesDatabaseHelper.INSTANCES_TABLE_NAME;
...
public class InstanceProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (instancesDatabaseHelper != null) {
            ...
            //c = qb.query(instancesDatabaseHelper.getWritableDatabase(), projection, selection, selectionArgs, null, null, sortOrder);
