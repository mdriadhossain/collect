...
package org.odk.collect.bdrs.database.helpers;

import android.database.SQLException;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import org.odk.collect.bdrs.database.DatabaseContext;
import org.odk.collect.bdrs.storage.StoragePathProvider;
import org.odk.collect.bdrs.storage.StorageSubdirectory;
import org.odk.collect.bdrs.utilities.SQLiteUtils;
...
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.AUTO_DELETE;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.AUTO_SEND;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.BASE64_RSA_PUBLIC_KEY;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.DATE;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.DESCRIPTION;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.DISPLAY_NAME;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.DISPLAY_SUBTEXT;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.FORM_FILE_PATH;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.FORM_MEDIA_PATH;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.GEOMETRY_XPATH;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.JRCACHE_FILE_PATH;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.JR_FORM_ID;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.JR_VERSION;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.LANGUAGE;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.LAST_DETECTED_FORM_VERSION_HASH;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.MD5_HASH;
import static org.odk.collect.bdrs.provider.FormsProviderAPI.FormsColumns.SUBMISSION_URI;
