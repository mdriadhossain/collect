...
import org.odk.collect.bdrs.activities.CaptureSelfieVideoActivity;
...
import org.odk.collect.bdrs.utilities.CameraUtils;
...
import org.odk.collect.bdrs.utilities.WidgetAppearanceUtils;
import org.odk.collect.bdrs.widgets.interfaces.FileWidget;
import org.odk.collect.bdrs.widgets.utilities.FileWidgetUtils;
...
import static org.odk.collect.bdrs.analytics.AnalyticsEvents.REQUEST_HIGH_RES_VIDEO;
import static org.odk.collect.bdrs.analytics.AnalyticsEvents.REQUEST_VIDEO_NOT_HIGH_RES;
...
public class VideoWidget extends QuestionWidget implements FileWidget {
     ...
     * @see org.odk.collect.bdrs.activities.FormEntryActivity#onActivityResult(int, int, Intent)
     */
    @Override
